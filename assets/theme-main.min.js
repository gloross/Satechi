     ...
     */ !(function (t, n) {
      ...
      var C =
        ...
        (function (e) {
          ...
          try {
            P.apply(($ = M.call(x.childNodes)), x.childNodes), $[x.childNodes.length].nodeType;
          } catch (e) {
            P = {
              apply: $.length
                ? function (e, t) {
          ...
          function ae(e, t, i, o) {
            ...
            if (!o && (f(t), (t = t || p), v)) {
              ...
              if (n.qsa && !E[e + " "] && (!m || !m.test(e)) && (1 !== x || "object" !== t.nodeName.toLowerCase())) {
                if (((g = e), (y = t), 1 === x && (B.test(e) || U.test(e)))) {
                  for (
          ...
          (ae.matchesSelector = function (e, t) {
            if ((f(e), n.matchesSelector && v && !E[t + " "] && (!g || !g.test(t)) && (!m || !m.test(t))))
              try {
                var i = y.call(e, t);
          ...
          function Te(e, t, n, i, o, r) {
            return (
              ...
              ce(function (r, s, a, l) {
                ...
                } else (g = ke(g === s ? g.splice(h, g.length) : g)), o ? o(null, s, g, l) : P.apply(s, g);
              })
            );
          }
          function Se(e) {
            for (
              ...
              if ((n = i.relative[e[l].type])) f = [be(xe(f), n)];
                ...
                if ((n = i.filter[e[l].type].apply(null, e[l].matches))[b]) {
                  ...
                  return Te(
                    l > 1 && xe(f),
                    l > 1 && we(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(F, "$1"),
                    n,
                    l < o && Se(e.slice(l, o)),
                    o < r && Se((e = e.slice(o))),
                    o < r && we(e)
            ...
            (s = ae.tokenize =
              function (e, t) {
                ...
                for (a = e, l = [], c = i.preFilter; a; ) {
                  for (s in ((n && !(o = W.exec(a))) || (o && (a = a.slice(o[0].length) || a), l.push((r = []))),
                  (n = !1),
                  (o = U.exec(a)) &&
                      ...
                      var n = t.length > 0,
                        ...
                        r = function (r, s, a, l, u) {
                          ...
                          if (((g += y), n && y !== g)) {
                            ...
                            P.apply(l, b), u && !r && b.length > 0 && g + t.length > 1 && ae.uniqueSort(l);
                          }
                          return u && ((k = S), (c = x)), w;
                        };
                      return n ? ce(r) : r;
      ...
      ((T.fn.init = function (e, t, n) {
        ...
        if (((n = n || D), "string" == typeof e)) {
          if (
            !(i = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : P.exec(e)) ||
            (!i[1] && t)
          )
          ...
          function (e, t) {
            T.fn[e] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 && (N[e] || T.uniqueSort(o), M.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
        ...
        T.extend({
          ...
          ready: function (e) {
            (!0 === e ? --T.readyWait : T.isReady) ||
              ((T.isReady = !0), (!0 !== e && --T.readyWait > 0) || F.resolveWith(w, [T]));
          },
        }),
        (T.ready.then = F.then),
        "complete" === w.readyState || ("loading" !== w.readyState && !w.documentElement.doScroll)
          ? n.setTimeout(T.ready)
          : (w.addEventListener("DOMContentLoaded", W), n.addEventListener("load", W));
      ...
      function V(e) {
        return e.replace(B, "ms-").replace(X, Y);
      }
      var J = function (e) {
      ...
      (T.event = {
        ...
        special: {
          ...
          click: {
            setup: function (e) {
              var t = this || e;
              return ve.test(t.type) && t.click && L(t, "input") && Ae(t, "click", Se), !1;
            },
            trigger: function (e) {
              var t = this || e;
      ...
      function qe(e, t, n, i) {
        ...
        var o,
          ...
          h = t[0],
          v = g(h);
        if (v || (f > 1 && "string" == typeof h && !m.checkClone && $e.test(h)))
        ...
        if (
          ...
          for (a = (s = T.map(we(o, "script"), Pe)).length; d < f; d++)
        ...
        style: function (e, t, n, i) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            var o,
              ...
              l = Ge.test(t),
              c = e.style;
            if ((l || (t = Ve(a)), (s = T.cssHooks[t] || T.cssHooks[a]), void 0 === n))
        ...
        (nt.propHooks = {
          _default: {
            ...
            set: function (e) {
              T.fx.step[e.prop]
                ? T.fx.step[e.prop](e)
                : 1 !== e.elem.nodeType || (!T.cssHooks[e.prop] && null == e.elem.style[Ve(e.prop)])
                ? (e.elem[e.prop] = e.now)
      ...
      function Lt(e, t, n, i) {
        ...
        if (Array.isArray(t))
          T.each(t, function (t, o) {
            n || Ct.test(e) ? i(e, o) : Lt(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, i);
          });
      ...
      T.ajaxSetup({
        ...
        (m.createHTMLDocument =
          (((Bt = w.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"),
      ...
      f = function (e) {
        ...
        try {
          for (var v, m = n.entries()[Symbol.iterator](); !(f = (v = m.next()).done); f = !0) {
            ...
            (E.innerHTML = (0, r.cartItem)(w + 1, x, k, T, S, C, j, t)), c.appendChild(E.content.firstChild);
          }
        } catch (e) {
          (p = !0), (h = e);
        } finally {
...
*/ var i = Object.getOwnPropertySymbols,
        ...
        (0, r.default)(".featured-collection").each(function () {
          ...
          e.on("init", function () {
            ...
            e.slick({
              ...
              slidesToScroll: 3,
              infinite: !1,
              prevArrow: e[0].closest(".container").querySelector(".arrow-left"),
              nextArrow: e[0].closest(".container").querySelector(".arrow-right"),
              draggable: !0,
              touchThreshold: 400,
  ...
  function (e, t, n) {
    ...
    var r = new (o(n(64)).default)(".js-copy-swell-referral-link", {
      text: function (e) {
        var t = e.getAttribute("data-trigger");
        return document.querySelector(t).innerText;
      },
    });
    r.on("success", function (e) {
      var t = (0, i.default)(".js-copy-swell-referral-link").text(),
        n = (0, i.default)(".js-copy-swell-referral-link").outerWidth();
      (0, i.default)(".js-copy-swell-referral-link")
        .css("width", n + "px")
        .text("Copied!"),
        setTimeout(function () {
          (0, i.default)(".js-copy-swell-referral-link").text(t).removeAttr("style");
        }, 4e3);
    }),
      r.on("error", function (e) {
        alert("There was an error copying your link. Please try again");
      });
    var s = (0, i.default)("#referral-customer-email"),
      a = (0, i.default)("#referral-customer-capture");
    (0, i.default)(a).on("click", function () {
      swellAPI.identifyReferrer(
        s.val(),
        function () {
          (0, i.default)(".js-customer-referral-email-error").addClass("hide"),
            (0, i.default)(".js-customer-no-account-signup").addClass("hide"),
            (0, i.default)(".js-customer-no-account-referral").removeClass("hide");
        },
        function () {
          (0, i.default)(".js-customer-referral-email-error").removeClass("hide");
        }
      );
    });
    var l = (0, i.default)("#referred-customers-input"),
      c = (0, i.default)("#referred-customers-send-btn");
    (0, i.default)(c).on("click", function () {
      var e = l.val().split(",");
      swellAPI.sendReferralEmails(
        e,
        function () {
          (0, i.default)(".js-referral-email-success").removeClass("hide"),
            setTimeout(function () {
              (0, i.default)(".js-referral-email-success").addClass("hide"), l.val("");
            }, 5e3);
        },
        function (e) {
          (0, i.default)(".js-referral-email-error").removeClass("hide"),
            setTimeout(function () {
              (0, i.default)(".js-referral-email-error").addClass("hide");
            }, 5e3);
        }
      );
    });
  ...
  function (e, t, n) {
    ...
    var i,
      ...
      r = (i = o) && i.__esModule ? i : {default: i};
    var s = function (e, t) {
        var n = document.querySelector(".js-rewards-grid");
        if (n) {
          for (var i = 0; i < e.length; i++) {
            var o = e[i],
              s = "";
            if ("$" == o.rewardText.slice(0, 1)) {
              var a = document.createElement("div");
              a.classList.add("rewards-grid-item"),
                o.customerCompleted && a.classList.add("campaign-completed"),
                (s =
                  null == o.backgroundImageUrl
                    ? "<div class='campaign-image no-bg-image'>&nbsp;</div>"
                    : "<div class='campaign-image' style='background-image: url(" +
                      o.backgroundImageUrl +
                      ");'>&nbsp;</div>"),
                (s += "<div class='campaign-cta'><span class='campaign-title'>" + o.title + "</span>"),
                o.customerCompleted
                  ? (s += "<div><i class='far fa-check'></i></div>")
                  : -1 !== o.title.indexOf("Refer")
                  ? (s += "<div><a class='swell-campaign-link--no-modal' href='/pages/refer'>Claim</a></div>")
                  : (s +=
                      "<div><a class='swell-campaign-link' href='#' data-campaign-id='" +
                      o.id +
                      "' data-display-mode='modal'>Claim</a></div>"),
                (s += "</div>"),
                (s += "<span class='campaign-dollar-amt'>" + o.rewardText + "</span>"),
                (a.innerHTML = s),
                n.appendChild(a);
            }
          }
          swellAPI.refreshEmbeds(),
            (0, r.default)(document).on("click", ".swell-campaign-link", function (e) {
              e.preventDefault();
            });
        }
      },
      a = function (e) {
        var t = document.querySelector(".js-swell-vip-tier");
        null == e && t && (t.innerText = "Basic Member");
      },
      l = function (e) {
        var t = document.querySelector(".js-swell-referrals-total"),
          n = 0;
        if (t) {
          for (var i = 0; i < e.length; i++) null !== e[i].completedAt && n++;
          t.innerText = n;
        }
      },
      c = function (e) {
        var t = document.querySelector(".js-rewards-bar"),
          n = document.querySelector(".js-rewards-bar-progress"),
          i = document.querySelector(".js-rewards-earned-text"),
          o = 0,
          r = 0;
        if (t && i) {
          for (var s = 0; s < e.length; s++) {
            var a = e[s];
            "$" == a.rewardText.slice(0, 1) && (o++, a.customerCompleted && r++);
          }
          (n.style.width = parseInt((r / o) * 100) + "%"), (i.innerText = r + "/" + o + " rewards claimed");
        }
      },
      u = function (e) {
        var t = document.querySelector(".js-upgrade-link");
        t && (null == e || e.length < 1) && t.classList.remove("hide");
      },
      d = document.querySelector(".js-rewards-customer-logged-in"),
      f = void 0;
    d &&
      (f = setInterval(function () {
        window.hasOwnProperty("Swell") &&
          window.hasOwnProperty("swellAPI") &&
          void 0 !== window.swellAPI.getCustomerDetails().created_at &&
          (clearInterval(f),
          setTimeout(function () {
            swellAPI.refreshEmbeds();
            var e = swellAPI.getCustomerDetails(),
              t = swellAPI.getActiveCampaigns();
            a(e.vipTier), l(e.referrals), u(e.vipTier), s(t, e.actionHistoryItems), c(t);
          }, 1500));
      }, 500));
  },
  function (e, t, n) {
    ...
    var i,
      ...
      r = (i = o) && i.__esModule ? i : {default: i};
    n(6),
      (0, r.default)(".js-testimonial-slides").length &&
        (0, r.default)(".js-testimonial-slides").each(function () {
          var e = (0, r.default)(this),
            t = e.attr("data-autoplay"),
            n = parseInt(e.attr("data-autoplay-speed"));
          e.find("[data-behavior='js-next-slide']").on("click", function (t) {
